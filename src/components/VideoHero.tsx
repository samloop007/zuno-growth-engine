...
const VideoHero = ({ titles, subtitle, videoSrc = heroVideo, posterSrc = heroPoster }: VideoHeroProps) => {
    return (
                ...
                <div className="space-y-8 max-w-4xl pt-20">
                    ...
                    <div className="flex flex-col space-y-1">
                        {titles.map((title, index) => (
                            <h1
                                key={index}
                                className={`text-5xl sm:text-6xl md:text-8xl font-black tracking-tighter leading-[0.9] uppercase animate-in fade-in slide-in-from-left-10 duration-700 ${index % 3 === 0 ? "text-white" :
                                    index % 3 === 1 ? "text-transparent bg-clip-text bg-gradient-to-r from-gray-100 to-gray-500" :
                                        "text-accent"
                                    }`}
